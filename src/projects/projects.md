...
{{ macros.ArticleThumb('./2026/mindstack/', 'MindStack Training Platform', 'Personal knowledge training platform that transforms your expertise into AI-assisted learning systems with in-place editing, duplicate detection, spaced repetition, and complete user control over content generation.') }}
